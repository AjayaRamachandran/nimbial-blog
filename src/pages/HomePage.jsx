...
function HomePage() {
  ...
  return (
    <>
      ...
      <div className="subtitle">Learn about our products and our takes on tech.</div>
      <div className="title-bar">Latest</div>

      <div className="homepage-grid-container">
        <div className="homepage-grid scrollable">
          {posts.map((post) => (
            <a key={post.slug} className="blog-card" href={'pages/' + post.slug}>
              ...
              <div className={"blog-card-category " + post.category.toLowerCase()}>
                {post.category}
              </div>
